...
- NFAI intelligence layer draft 7 – initial federated learning experiments on synthetic urban heat datasets with privacy budget ε=0.8
...
- NFAI feasibility minor note 2 – added reference: Gkatzelis et al., Urban Heat Island Modeling (2021)
...
- NFAI actualization layer note 1 - initial sketch of edge-cloud hybrid anomaly detection with privacy budget ��=0.8 
- NFAI actualization layer note 2 - initial sketch of edge-cloud hybrid anomaly detection with privacy budget ��=0.8 
- NFAI actualization layer note 3 - initial sketch of edge-cloud hybrid anomaly detection with privacy budget ��=0.8 
...
Debug user gesture detection [2022-02-21 21:25:58]
